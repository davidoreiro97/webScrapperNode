...
export async function arcoirisScrapper(nombreProducto, instanciaNavegador) {
	let resultadoBusqueda = [];
	const url_pagina_supermercado = "https://arcoirisencasa.com.ar/login.asp";
	...
	try {
		await pagina.waitForSelector("#Resultados-In", { timeout: 10000 });
		try {
