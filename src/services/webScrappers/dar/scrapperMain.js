...
export async function darScrapper(nombreProducto, instanciaNavegador) {
	let resultadoBusqueda = [];
	const url_pagina_supermercado = "https://www.darentucasa.com.ar/login.asp";
	...
	try {
		await pagina.waitForSelector("#Resultados-In", { timeout: 30000 });
		try {
